...
| Keyboard navigation shortcuts (g/d/f view switch, l DG layout, b DD lens, `/` search-focus; pure resolver + global hook; editable/modifier guards) | keyboard-nav-shortcuts | keyboard-nav-shortcuts | commands | — |
