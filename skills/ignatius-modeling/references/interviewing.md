...
- **Infer before asking.** Read existing entities under `data/`, `groups/`, and `ignatius.yml` first to detect the convention, list groups, and prefill answers. Ask only what the files cannot tell you.
