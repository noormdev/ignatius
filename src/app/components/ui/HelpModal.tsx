...
const GRAPH_EXPLORE: Row[] = [
  ...
  { term: 'Search', desc: 'Type to highlight matches and dim the rest; toggle Body to also match markdown text; Enter cycles through matches.' },
];
...
const FLOW_EXPLORE: Row[] = [
  ...
  { term: 'Search', desc: 'Type to find matches across every diagram, including sub-DFDs — results list by diagram; click one to navigate there. Non-matches dim in the diagram.' },
];
...
function shortcutRows(view: ViewName): Row[] {
  ...
  rows.push({ term: '/', desc: 'Focus the search bar.' });
