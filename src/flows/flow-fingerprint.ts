 ...
 * src/server/server.ts (via buildFlowLayoutKeys) to build the id→fingerprint map.
 */
/**
 ...
 *
 * Used by src/server/server.ts (/api/flow route) and src/generators/app.ts (export).
 */
