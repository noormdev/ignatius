...
[`src/app/styles.css`](../../src/app/styles.css) — full SPA stylesheet. Key additions: `@media print` block (CP10), `::highlight(dd-search-highlight)` (CP9), `.dict-process-direction` badges, `.flow-minimap-wrapper` (left: 16px, CP19), `.zoom-control` (CP22/CP23). DD chrome: `.dict-view` (full-width scroll container), `.dict-view-inner`, `.dict-search-bar` (fixed frosted top bar), `.dict-browse-lens`, `.dict-grid-card`, `.dict-flow-grid-card`, `.spotlight-overlay`, `.spotlight-line`, `.spotlight-line--flow`, `.spotlight-chips-container`, chip sub-classes, `.dict-browse-focus-bar`.
