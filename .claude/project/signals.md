...
| Language | LOC | Files | % |
|----------|-----|-------|---|
| TypeScript | 51667 | 243 | 69% |
| Markdown | 18725 | 287 | 25% |
| CSS | 2650 | 2 | 3% |
| YAML | 1337 | 13 | 1% |
| Shell | 116 | 1 | 0% |
| JSON | 102 | 4 | 0% |
...
**Level derivation ([`src/flows/flow-derive-levels.ts`](../../src/flows/flow-derive-levels.ts), 426L):** exports `deriveLevels(flowModel: FlowModel): FlowModel`, `CONTEXT_DIAGRAM_ID = '__context__'`, `SYSTEM_PROCESS_ID = '__system__'`, `SYNTHETIC_DIAGRAM_IDS: ReadonlySet<string>`. Pure module — no I/O. Takes the flat parsed diagram array and inserts two synthetic diagrams into the tree:
