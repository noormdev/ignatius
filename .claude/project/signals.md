...
- **Logic (pure, no DOM/React):**
  ...
  - [`src/app/logic/spotlight-inherited.ts`](../../src/app/logic/spotlight-inherited.ts) (158L) — pure inherited-connection logic for the DD browse lens (#9). No DOM, no React, no Bun/Node imports. Exports `buildInheritedConnections(index: ModelIndex, entityId: string): InheritedConnection[]`, `InheritedConnection = { otherId, direction: 'out'|'in'|'both', via: string }`, `INHERITED_IDENTITY = 'identity'`. Scope: subtype-cluster members and basetypes only (not general identifying-1:1 dependents). Member active → surface basetype + sibling identity links + basetype's direct FK connections. Basetype active → surface each member + each member's direct FK connections. De-duplication against the active entity's OWN direct connections (`buildSpotlightConnections`) is applied to ALL inherited connections including identity links — a subtype's direct identifying FK to its basetype renders once as the solid direct line, not also as a dotted inherited identity. Bundles to one entry per otherId (first-seen wins); result sorted ascending by otherId; unknown/unclassified → []. Imported by [`src/app/components/entity/SpotlightOverlay.tsx`](../../src/app/components/entity/SpotlightOverlay.tsx).
...
- **Views:**
  ...
  - [`src/app/views/graph/navigator.ts`](../../src/app/views/graph/navigator.ts) — `mountNavigator` / `teardownNavigator` / `NavigatorInstance` — cytoscape-navigator lifecycle helpers.
...
- [`src/app/logic/spotlight.ts`](../../src/app/logic/spotlight.ts) imported by [`src/app/views/dict/DictionaryView.tsx`](../../src/app/views/dict/DictionaryView.tsx) and [`src/app/logic/spotlight-inherited.ts`](../../src/app/logic/spotlight-inherited.ts) (uses `buildSpotlightConnections` for de-dup). [`src/app/logic/flow-spotlight.ts`](../../src/app/logic/flow-spotlight.ts) imported by [`src/app/views/dict/DictionaryView.tsx`](../../src/app/views/dict/DictionaryView.tsx) only. [`src/app/logic/spotlight-lines.ts`](../../src/app/logic/spotlight-lines.ts) imported by [`src/app/components/entity/SpotlightOverlay.tsx`](../../src/app/components/entity/SpotlightOverlay.tsx) only. [`src/app/logic/spotlight-inherited.ts`](../../src/app/logic/spotlight-inherited.ts) imported by [`src/app/components/entity/SpotlightOverlay.tsx`](../../src/app/components/entity/SpotlightOverlay.tsx) only. [`src/app/components/entity/SpotlightOverlay.tsx`](../../src/app/components/entity/SpotlightOverlay.tsx) imported by [`src/app/views/dict/DictionaryView.tsx`](../../src/app/views/dict/DictionaryView.tsx) only. [`src/app/components/entity/GridCard.tsx`](../../src/app/components/entity/GridCard.tsx) imported by [`src/app/views/dict/DictionaryView.tsx`](../../src/app/views/dict/DictionaryView.tsx) only. [`src/app/components/entity/FlowNodeGridCard.tsx`](../../src/app/components/entity/FlowNodeGridCard.tsx) imported by [`src/app/views/dict/DictionaryView.tsx`](../../src/app/views/dict/DictionaryView.tsx) only. The spotlight-grid cluster (7 modules) is self-contained: changes force changes only within the DD browse-lens feature.
